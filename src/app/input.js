// src/app/input.js — keyboard / mouse / pointer-lock / gamepad / touch state.
...
// buttons driven by src/app/touch.js. Each source is tracked in its own set so releasing one can
...
export class Input {
  ...
  // --- touch feeds ----------------------------------------------------------
  // src/app/touch.js owns the gestures; these three doors are the only way it reaches the rest of
